...
var a11y = [
  ...
  },
  {
    ...
    match(element) {
      ...
      for (const elementRole of elementRoles) {
        const { requiredProps } = import_aria_query.roles.get(elementRole);
  ...
  },
  {
    ...
    match(element) {
      ...
      const elementRoles = role.split(WHITESPACE_REGEX);
      for (const elementRole of elementRoles) {
        const { props } = import_aria_query.roles.get(elementRole);
...
//# sourceMappingURL=audit-TIGMP2CJ.js.map
